    ...
    <LegalLayout title="Terms of Service">
      <section>
        ...
        <p>
          ...
          the Sim platform (the "Service") operated by Sim, Inc ("us", "we", or
          "our").
        </p>
        <p className="mt-4">
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          the Service for your internal business or personal purposes.
        </p>
        <p>
          This license does not permit you to resell, redistribute, or make the
          Service available to third parties, or to use the Service to build a
      ...
      <section>
        ...
        <p className="mb-4">
          We offer Free, Pro, Team, and Enterprise subscription plans. Paid
          plans include a base subscription fee plus usage-based charges for
          inference and other services that exceed your plan's included limits.
        </p>
        <p className="mb-4">
          You agree to pay all fees associated with your account. Your base
          subscription fee is charged at the beginning of each billing cycle
          (monthly or annually). Inference overages are charged incrementally
          every $50 during your billing period, which may result in multiple
          invoices within a single billing cycle. Payment is due upon receipt of
          invoice. If payment fails, we may suspend or terminate your access to
          paid features.
        </p>
        <p>
          We reserve the right to change our pricing with 30 days' notice to
          paid subscribers. Price changes will take effect at your next renewal.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          period unless you cancel before the renewal date. You can cancel your
          subscription at any time through your account settings or by
          contacting us.
        </p>
        <p className="mb-4">
          Cancellations take effect at the end of the current billing period.
          You will retain access to paid features until that time. We do not
          provide refunds for partial billing periods.
        </p>
        <p>
          Upon cancellation or termination, you may export your data within 30
          days. After 30 days, we may delete your data in accordance with our
      ...
      <section>
        ...
        <p className="mb-4">
          You retain all ownership rights to data, content, and information you
          submit to the Service ("Your Data"). You grant us a limited license to
          process, store, and transmit Your Data solely to provide and improve
          the Service as described in our Privacy Policy.
        </p>
        <p>
          We retain Your Data while your account is active and for 30 days after
          account termination or cancellation. You may request data export or
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          and will remain the exclusive property of Sim, Inc and its licensors.
        ...
        <p>
          ...
          product or service without the prior written consent of Sim, Inc.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>
            The User Content is yours (you own it) or you have the right to use
            it and grant us the rights and license as provided in these Terms.
          </li>
          <li>
            The posting of your User Content on or through the Service does not
            violate the privacy rights, publicity rights, copyrights, contract
            rights or any other rights of any person.
          </li>
        </ul>
        <p>
          We reserve the right to terminate the account of any user found to be
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          Workspace, cloud storage providers, and AI model providers). Your use
          of third-party services is subject to their respective terms and
          privacy policies.
        </p>
        <p>
          We are not responsible for the availability, functionality, or actions
          of third-party services. Any issues with third-party integrations
          should be directed to the respective provider.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            harm Sim, Inc or users of the Service or expose them to liability.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="mb-4">
          In no event shall Sim, Inc, nor its directors, employees, partners,
      ...
      <section>
        ...
        <p>
          Sim, Inc, its subsidiaries, affiliates, and its licensors do not
          warrant that:
        </p>
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>
      ...
      <section>
        ...
        <p>
          You agree to indemnify, defend, and hold harmless Sim, Inc and its
      ...
      <section>
        ...
        <p className="mb-4">
          Please read the following arbitration agreement carefully. It requires
          you to arbitrate disputes with Sim, Inc, its parent companies,
        ...
        <p className="mb-4">
          ...
          relating to the Site, the Service or these Terms will be resolved by
          binding arbitration, rather than in court, except that (1) you and the
          Company Parties may assert individualized claims in small claims court
          if the claims qualify, remain in such court and advance solely on an
          individual, non-class basis; and (2) you or the Company Parties may
        ...
        <p className="mb-4 border-[var(--brand-primary-hex)] border-l-4 bg-[var(--brand-primary-hex)]/10 p-3">
          ...
          OTHER ONLY ON AN INDIVIDUAL BASIS AND NOT ON A CLASS, REPRESENTATIVE,
          OR COLLECTIVE BASIS. ONLY INDIVIDUAL RELIEF IS AVAILABLE, AND DISPUTES
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          our Service do the same. If you believe that one of our users is,
          through the use of our Service, unlawfully infringing the copyright(s)
          in a work, please send a notice to our designated Copyright Agent,
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          ...
          <li>
            A statement, made under the penalty of perjury, that the above
        ...
        <p>
          ...
          <Link
            href="mailto:copyright@ethana.ai"
            className="text-[var(--brand-primary-hex)] underline hover:text-[var(--brand-primary-hover-hex)]"
          >
            copyright@ethana.ai
          </Link>
