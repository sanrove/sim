    ...
    <LegalLayout title="Privacy Policy">
      <section>
        ...
        <p>
          ...
          Service") collects, uses, discloses, and protects personal data —
          including data obtained from Google APIs (including Google Workspace
          APIs) — and your rights and controls regarding that data.
        </p>
        <p className="mt-4">
          By using or accessing the Service, you confirm that you have read and
      ...
      <section>
        ...
        <p className="mb-4">
          Under the following conditions, the meanings of words with capitalized
          first letters are defined. The following definitions have the same
          meaning whether they are written in singular or plural form.
        </p>
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>
            <strong>Application</strong> or <strong>Service</strong> means the
            Sim web or mobile application or related services.
          </li>
          <li>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Sim. For the purpose of
          ...
          <li>
            ...
            cultural or social identity. For the purposes of the CCPA, Personal
            Data means any information that identifies, relates to, describes or
            is capable of being associated with, or could reasonably be linked,
            directly or indirectly, with You.
          </li>
          <li>
            <strong>Google Data</strong> means any data, content, or metadata
            obtained via Google APIs (including Google Workspace APIs).
          </li>
          <li>
            <strong>Generalized AI/ML model</strong> means an AI or ML model
            intended to be broadly trained across multiple users, not specific
            to a single user's data or behavior.
          </li>
          <li>
            <strong>User-facing features</strong> means features directly
            visible or used by the individual user through the app UI.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Sim, accessible from ethana.ai
          </li>
          <li>
      ...
      <section>
        ...
        <p className="mb-4">
          When you sign up, link accounts, or use features, you may provide
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          ...
          <li>
            Any data you explicitly input or connect, including via Google
            integrations
          </li>
        </ul>
        ...
        <p className="mb-4">
          If you choose to connect your Google account (e.g., Google Workspace,
          Gmail, Drive, Calendar, Contacts), we may request specific scopes.
          Types of Google Data we may access include:
        </p>
        <ul className="mb-4 list-disc space-y-2 pl-6">
        ...
        <p className="mb-4">
          We only request the minimal scopes necessary for the features you
          enable. We do not request scopes for unimplemented features.
        </p>
      ...
      <section>
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            To enable and support user-enabled integrations with Google services
            (e.g., syncing files or calendar) and provide personalization,
            suggestions, and user-specific automation for that individual user.
          </li>
          <li>
            To detect and prevent fraud, abuse, or security incidents and to
            comply with legal obligations.
          </li>
        </ul>
        <p className="mt-4">
          <strong>Importantly:</strong> any Google Data used within Sim is used
          only for features tied to that specific user (user-facing features),
          and <strong>never</strong> for generalized AI/ML training or shared
          model improvement across users.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4">
          Sim may disclose your Personal Information in the good faith belief
      ...
      <section>
        ...
        <p className="mb-4">
          We may aggregate or anonymize non-Google data (not tied to personal
          identity) for internal analytics, product improvement, usage trends,
          or performance monitoring. This data cannot be tied back to individual
          users and is not used for generalized AI/ML training with Google Data.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4">
          Google Ads remarketing service is provided by Google Inc. You can
      ...
      <section>
        ...
        <p className="mb-4">
          Sim’s use, storage, processing, and transfer of Google Data (raw or
          derived) strictly adheres to the Google API Services User Data Policy,
          including the Limited Use requirements, and to the Google Workspace
          API user data policy (when applicable). We explicitly affirm that:
        </p>
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>
            Sim does not use, transfer, or allow Google Data to be used to
            train, improve, or develop generalized or non-personalized AI/ML
            models.
          </li>
          <li>
            Any processing of Google Data is limited to providing or improving
            user-facing features visible in the app UI.
          </li>
          <li>
            We do not allow third parties to access Google Data for purposes of
            training or model improvement.
          </li>
          <li>
            Transfers of Google Data are disallowed except in limited permitted
            cases.
          </li>
        </ul>
        ...
        <p className="mb-4">
          We may only transfer Google Data (raw or derived) to third parties
          under the following limited conditions and always aligned with user
          disclosures and consent:
        </p>
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>
            To provide or improve user-facing features (with the user's explicit
            consent)
          </li>
          <li>For security, abuse investigation, or system integrity</li>
          <li>To comply with laws or legal obligations</li>
          <li>
            As part of a merger, acquisition, divestiture, or sale of assets,
        ...
        <p className="mb-4">
          We restrict human review of Google Data strictly. No employee,
          contractor, or agent may view Google Data unless one of the following
          is true:
        </p>
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>
            The user gave explicit, documented consent to view specific items
            (e.g., "Let customer support view this email/file").
          </li>
          <li>
            It is necessary for security, abuse investigation, or legal process.
          </li>
          <li>
            Data is aggregated, anonymized, and used for internal operations
            only (without re-identification).
          </li>
        </ul>
        ...
        <p className="mb-4">
          We only request scopes essential to features you opt into; we do not
          request broad or unused permissions. For each Google API scope we
          request, we maintain internal documentation justifying why that scope
          is needed and why narrower scopes are insufficient. Where possible, we
          follow incremental authorization and request additional scopes only
          when needed in context.
        </p>
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          ...
          <li>
            Access controls, role-based permissions, logging, and auditing
            protect data.
          </li>
          <li>
            OAuth tokens and credentials are stored securely (e.g., encrypted
            vault, hardware or secure key management).
          </li>
          <li>We regularly review security practices and infrastructure.</li>
          <li>
            If a security incident affects Google Data, we will notify Google as
            required and cooperate fully.
          </li>
        </ul>
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>
            <strong>Account Data:</strong> Retained during active account + 30
            days after deletion request
          </li>
          <li>
            <strong>Google API Data:</strong> Retained during feature use + 7
            days after revocation or account deletion
          </li>
          <li>
            <strong>Usage Logs:</strong> 90 days for analytics; up to 1 year for
            security investigations
          </li>
          <li>
            <strong>Transaction Records:</strong> Up to 7 years for legal and
            tax compliance
          </li>
        </ul>
        <p className="mb-4">
          When you revoke access, delete your account, or stop using a feature,
          we remove associated data within the timeframes above. You may request
          deletion via in-app settings or by contacting us; we will comply
          promptly.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          are aware that your Children has provided us with Personal
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          certain data protection rights. Sim aims to take reasonable steps to
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            your consent at any time where Sim relied on your consent to process
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          Act (CPRA), including the right to know what personal information we
          collect, the right to delete your information, and the right to
        ...
        <p className="mb-4">
          ...
          However, some data sharing practices (such as analytics or advertising
          services) may be considered a "sale" or "share" under CCPA/CPRA. You
          have the right to opt-out of such data sharing. To exercise this
          right, contact us at{" "}
          <Link
            href="mailto:privacy@ethana.ai"
        ...
        <p className="mb-4">
          We recognize and honor Global Privacy Control (GPC) signals. When your
          browser sends a GPC signal, we will treat it as a valid request to
          opt-out of the sale or sharing of your personal information.
        </p>
        ...
        <p className="mb-4">
          ...
          request information about categories of personal information we
          disclosed to third parties for direct marketing purposes in the
          preceding calendar year.
        </p>
        <p>
          To make a request under CCPA or the Shine The Light law, please submit
          your request using the contact information provided below.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4">
          Sim is dedicated to preserving data security by preventing
          unauthorized disclosure of information. This policy was created to
          provide security researchers with instructions for conducting
          vulnerability discovery activities and to provide information on how
          to report vulnerabilities that have been discovered. This policy
          explains which systems and sorts of activity are covered, how to send
          vulnerability reports, and how long we require you to wait before
          publicly reporting vulnerabilities identified.
        </p>
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            obtain data, establish command line access and/or persistence, or
            use the exploit to "pivot" to other systems.
          </li>
          <li>
            Once you've established that a vulnerability exists or encounter any
            sensitive data (including personal data, financial information, or
            proprietary information or trade secrets of any party), you must
            stop your test, notify us immediately, and keep the data strictly
            confidential.
          </li>
        ...
        <p className="mb-4">
          ...
          permissible. We'll work with you to swiftly understand and fix the
          problem, and Sim will not suggest or pursue legal action in connection
          with your study.
        </p>
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>ethana.ai website</li>
          <li>Sim web application</li>
          <li>Sim API services</li>
        </ul>
        <p className="mb-4">
          Any service that isn't explicitly specified above, such as related
          services, is out of scope and isn't allowed to be tested.
          Vulnerabilities discovered in third-party solutions Sim interacts with
          are not covered by this policy and should be reported directly to the
          solution vendor in accordance with their disclosure policy (if any).
          Before beginning your inquiry, email us at{" "}
          <Link
            href="mailto:security@ethana.ai"
            className="text-[var(--brand-primary-hex)] underline hover:text-[var(--brand-primary-hover-hex)]"
          >
            security@ethana.ai
          </Link>{" "}
        ...
        <p className="mb-4">
          ...
          vulnerability report and keep you updated on our progress. Reports can
          be anonymously submitted.
        </p>

        <h3 className="mb-2 font-medium text-xl">Desirable information</h3>
        <p className="mb-4">
          In order to process and react to a vulnerability report, we recommend
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          ...
          <li>
            Steps required to reproduce a vulnerability (include scripts and
        ...
        <p className="mb-4">
          ...
          communicate with you in a transparent and timely manner. We will
          acknowledge receipt of your report within three business days. We will
          keep you informed on vulnerability confirmation and remedy to the best
          of our capabilities. We welcome a discussion of concerns and are
          willing to engage in a discourse.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4">
          If you have questions, requests, or complaints regarding this Privacy
