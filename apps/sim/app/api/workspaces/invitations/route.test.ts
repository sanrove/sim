  ...
  beforeEach(() => {
    ...
    vi.doMock("@/lib/core/config/env", () => ({
      env: {
        ...
        FROM_EMAIL_ADDRESS: "Sim <noreply@test.ethana.ai>",
        EMAIL_DOMAIN: "test.ethana.ai",
      },
    }));
    ...
    vi.doMock("drizzle-orm", () => ({
      and: vi
        .fn()
        .mockImplementation((...args) => ({ type: "and", conditions: args })),
      eq: vi
        .fn()
        .mockImplementation((field, value) => ({ type: "eq", field, value })),
      inArray: vi
        .fn()
        .mockImplementation((field, values) => ({
          type: "inArray",
          field,
          values,
        })),
