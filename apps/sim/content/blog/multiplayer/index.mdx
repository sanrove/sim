...
canonical: https://ethana.ai/studio/multiplayer
draft: false
---
...
Undo stacks are **per-user**. Your undo history doesn't include others' changes. This matches user expectations: Cmd+Z undoes _your_ recent actions, not your collaborator's.
...
_Interested in how Sim's multiplayer system works in practice? [Try building a workflow](https://ethana.ai) with a collaborator in real-time._
