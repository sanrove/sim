...
export const WordPressBlock: BlockConfig<WordPressResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/wordpress",
  category: "tools",
  bgColor: "#21759B",
  icon: WordpressIcon,
  subBlocks: [
        ...
        switch (params.operation) {
          case "wordpress_create_post":
            return {
              ...
              tags: params.tags,
              featuredMedia: params.featuredMedia
          ...
          case "wordpress_list_comments":
            return {
              ...
              perPage: params.perPage ? Number(params.perPage) : undefined,
              page: params.page ? Number(params.page) : undefined,
              postId: params.commentPostId
                ? Number(params.commentPostId)
                : undefined,
              search: params.search,
              orderBy: params.orderBy,
              order: params.order,
