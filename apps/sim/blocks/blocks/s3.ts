...
export const S3Block: BlockConfig<S3Response> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/s3",
  category: "tools",
  ...
  subBlocks: [
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["put_object", "list_objects", "delete_object"],
      },
      required: true,
    },
          ...
          case "list_objects":
            ...
            return {
              ...
              maxKeys: params.maxKeys
                ? Number.parseInt(params.maxKeys as string, 10)
                : undefined,
  ...
  outputs: {
    ...
    objects: {
      type: "json",
      description: "List of objects (for list operation)",
    },
