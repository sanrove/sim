...
export const DynamoDBBlock: BlockConfig<DynamoDBResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/dynamodb",
  category: "tools",
  ...
  tools: {
    ...
    config: {
      ...
      params: (params) => {
        ...
        if (rest.keyConditionExpression)
          result.keyConditionExpression = rest.keyConditionExpression;
        if (rest.updateExpression)
          result.updateExpression = rest.updateExpression;
        if (rest.filterExpression)
          result.filterExpression = rest.filterExpression;
        if (rest.projectionExpression)
          result.projectionExpression = rest.projectionExpression;
        ...
        if (rest.conditionExpression)
          result.conditionExpression = rest.conditionExpression;
  ...
  inputs: {
    ...
    key: {
      type: "json",
      description: "Primary key for get/update/delete operations",
    },
    item: { type: "json", description: "Item to put into the table" },
    keyConditionExpression: {
      type: "string",
      description: "Key condition for query operations",
    },
    updateExpression: {
      type: "string",
    ...
    projectionExpression: {
      type: "string",
      description: "Attributes to retrieve in scan",
    },
    expressionAttributeNames: {
      type: "json",
