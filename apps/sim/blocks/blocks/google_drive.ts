...
export const GoogleDriveBlock: BlockConfig<GoogleDriveResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/google_drive",
  category: "tools",
  bgColor: "#E0E0E0",
  ...
  subBlocks: [
    ...
    // Export format for Google Workspace files (download operation)
    {
      ...
      placeholder:
        "Optional: Choose export format for Google Docs/Sheets/Slides",
      condition: { field: "operation", value: "download" },
    },
    {
      id: "fileName",
  ...
  inputs: {
    ...
    mimeType: {
      type: "string",
      description: "File MIME type or export format",
    },
