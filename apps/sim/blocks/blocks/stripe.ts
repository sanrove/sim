...
export const StripeBlock: BlockConfig<StripeResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/stripe",
  category: "tools",
  bgColor: "#635BFF",
  icon: StripeIcon,
  subBlocks: [
    ...
    config: {
      ...
      params: (params) => {
        ...
        if (auto_advance !== undefined)
          parsedBooleans.auto_advance = auto_advance === "true";
        ...
        if (invoice_now !== undefined)
          parsedBooleans.invoice_now = invoice_now === "true";
