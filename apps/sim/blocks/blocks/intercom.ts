...
export const IntercomBlock: BlockConfig = {
  ...
  docsLink: "https://docs.ethana.ai/tools/intercom",
      ...
      params: (params) => {
        ...
        if (operation === "create_ticket") {
          ...
          if (ticket_created_at)
            cleanParams.created_at = Number(ticket_created_at);
          if (
            disable_notifications !== undefined &&
            disable_notifications !== ""
          ) {
            cleanParams.disable_notifications =
