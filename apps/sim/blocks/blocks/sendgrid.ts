...
export const SendGridBlock: BlockConfig<SendMailResult> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/sendgrid",
  category: "tools",
  bgColor: "#1A82E2",
  icon: SendgridIcon,
  ...
  inputs: {
    ...
    mailTemplateId: {
      type: "string",
      description: "Template ID for sending mail",
    },
    ...
    contactListIds: {
      type: "string",
      description: "Comma-separated list IDs for contact",
    },
    // List inputs
    ...
    listPageSize: {
      type: "number",
      description: "Page size for listing lists",
    },
    // Template inputs
    ...
    templateGenerations: {
      type: "string",
      description: "Filter templates by generation",
    },
    templatePageSize: {
      type: "number",
      description: "Page size for listing templates",
    },
    ...
    active: {
      type: "boolean",
      description: "Whether template version is active",
    },
  },
  ...
  outputs: {
    ...
    subject: {
      type: "string",
      description: "Email subject (send_mail, create_template_version)",
    },
    // Contact outputs
