...
export const PipedriveBlock: BlockConfig<PipedriveResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/pipedrive",
  category: "tools",
  bgColor: "#2E6936",
  icon: PipedriveIcon,
  subBlocks: [
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["get_activities", "create_activity"],
      },
    },
    {
      id: "person_id",
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["create_activity", "update_activity"],
      },
    },
    {
      id: "type",
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["create_lead", "update_lead", "get_leads"],
      },
    },
    {
      id: "organization_id",
