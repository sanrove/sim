...
export const PerplexityBlock: BlockConfig<PerplexityResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/perplexity",
  category: "tools",
      ...
      params: (params) => {
        if (params.operation === "perplexity_search") {
          ...
          if (
            ...
            typeof params.search_domain_filter === "string"
          ) {
          ...
          const searchParams = {
            ...
            max_results: params.max_results
              ? Number.parseInt(params.max_results)
              : undefined,
  ...
  inputs: {
    ...
    search_domain_filter: {
      type: "string",
      description: "Domain filter (comma-separated)",
    },
