...
export const MailchimpBlock: BlockConfig = {
  ...
  docsLink: "https://docs.ethana.ai/tools/mailchimp",
  ...
  subBlocks: [
    ...
    },
    {
      ...
      type: "long-input",
      placeholder:
        "JSON object with company, address1, city, state, zip, country",
      required: {
        field: "operation",
        value: ["create_audience"],
      },
    ...
    },
    {
      ...
      type: "long-input",
      placeholder:
        'JSON object with merge field values (e.g., {"FNAME": "John", "LNAME": "Doe"})',
      condition: {
        field: "operation",
    ...
    },
    {
      ...
      type: "long-input",
      placeholder:
        "JSON object with subject_line, from_name, reply_to, etc. (required for create)",
      required: {
        field: "operation",
        value: ["create_campaign"],
      },
