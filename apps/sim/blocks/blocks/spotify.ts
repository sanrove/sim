...
export const SpotifyBlock: BlockConfig<ToolResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/spotify",
  category: "tools",
  bgColor: "#000000",
  icon: SpotifyIcon,
  subBlocks: [
    ...
    // === ALBUM ID ===
    {
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_album", "spotify_get_album_tracks"],
      },
    },
    {
      id: "albumIds",
    ...
    // === SHOW IDs ===
    {
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_show", "spotify_get_show_episodes"],
      },
    },
    {
      id: "showIds",
    ...
    // === CHECK PLAYLIST FOLLOWERS ===
    {
      ...
      condition: {
        field: "operation",
        value: "spotify_check_playlist_followers",
      },
    },
    ...
    // === REORDER PLAYLIST ===
    {
      ...
      condition: {
        field: "operation",
        value: "spotify_reorder_playlist_items",
      },
    },
    {
      id: "insert_before",
  ...
  inputs: {
    ...
    audiobookIds: {
      type: "string",
      description: "Comma-separated audiobook IDs",
    },
    ...
    target_device_id: {
      type: "string",
      description: "Target device ID for transfer",
    },
    // Common
  ...
  outputs: {
    ...
    playlists: {
      ...
      condition: {
        field: "operation",
        value: ["spotify_search", "spotify_get_user_playlists"],
      },
    },
    ...
    duration_ms: {
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_track", "spotify_get_episode"],
      },
    },
    explicit: {
      type: "boolean",
    ...
    release_date: {
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_album", "spotify_get_episode"],
      },
    },
    label: {
      type: "string",
    ...
    total_tracks: {
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_album", "spotify_get_playlist"],
      },
    },
    genres: {
      type: "json",
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_album", "spotify_get_artist"],
      },
    },
    ...
    owner: {
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_playlist", "spotify_create_playlist"],
      },
    },
    public: {
      type: "boolean",
    ...
    publisher: {
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_show", "spotify_get_audiobook"],
      },
    },
    total_episodes: {
      type: "number",
    ...
    shows: {
      ...
      condition: {
        field: "operation",
        value: ["spotify_get_shows", "spotify_get_saved_shows"],
      },
    },
    languages: {
      type: "json",
    ...
    chapters: {
      ...
      condition: {
        field: "operation",
        value: "spotify_get_audiobook_chapters",
      },
    },
