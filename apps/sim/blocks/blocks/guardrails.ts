...
export const GuardrailsBlock: BlockConfig<GuardrailsResponse> = {
  ...
  `,
  docsLink: "https://docs.ethana.ai/blocks/guardrails",
  category: "blocks",
  bgColor: "#3D642D",
    ...
    },
    {
      ...
      options: () => {
        ...
        const allModels = Array.from(
          new Set([...baseModels, ...ollamaModels, ...openrouterModels])
        );
  ...
  inputs: {
    input: {
      type: "string",
      description:
        "Content to validate (automatically receives input from wired block)",
    },
    validationType: {
      type: "string",
      description:
        "Type of validation to perform (json, regex, hallucination, or pii)",
    },
    regex: {
      type: "string",
    ...
    threshold: {
      type: "string",
      description:
        "Confidence threshold (0-10 scale, default: 3, scores below fail)",
    },
    topK: {
      type: "string",
      description:
        "Number of chunks to retrieve from knowledge base (default: 5)",
    },
    model: {
      type: "string",
    ...
    piiEntityTypes: {
      type: "json",
      description:
        "PII entity types to detect (array of strings, empty = detect all)",
    },
    piiMode: {
      type: "string",
  ...
  outputs: {
    ...
    reasoning: {
      type: "string",
      description:
        "Reasoning for confidence score (only for hallucination check)",
    },
    detectedEntities: {
      type: "array",
