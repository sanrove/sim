...
export const PolymarketBlock: BlockConfig = {
  ...
  docsLink: "https://docs.ethana.ai/tools/polymarket",
  category: "tools",
  bgColor: "#4C82FB",
  icon: PolymarketIcon,
  subBlocks: [
  ...
  outputs: {
    ...
    series: {
      type: "json",
      description:
        "Array or single series object (get_series, get_series_by_id)",
    },
    positions: {
      type: "json",
    ...
    price: {
      type: "string",
      description: "Market price (get_price, get_last_trade_price)",
    },
    midpoint: { type: "string", description: "Midpoint price (get_midpoint)" },
    history: {
      type: "json",
      description: "Price history entries (get_price_history)",
    },
    spread: { type: "json", description: "Bid-ask spread (get_spread)" },
    tickSize: {
      type: "string",
      description: "Minimum tick size (get_tick_size)",
    },
  },
};
