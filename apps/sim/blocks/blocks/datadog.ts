...
export const DatadogBlock: BlockConfig<DatadogResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/datadog",
  category: "tools",
  bgColor: "#632CA6",
  icon: DatadogIcon,
  subBlocks: [
        ...
        switch (params.operation) {
          ...
          case "datadog_create_monitor":
            return {
              ...
              priority: params.monitorPriority
          ...
          case "datadog_create_downtime":
            return {
              ...
              start: params.downtimeStart
                ? Number(params.downtimeStart)
                : undefined,
  ...
  inputs: {
    ...
    downtimeMonitorId: {
      type: "string",
      description: "Monitor ID for downtime",
    },
    currentOnly: {
      type: "boolean",
      description: "Filter to current downtimes",
    },
