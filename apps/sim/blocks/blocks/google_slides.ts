...
export const GoogleSlidesBlock: BlockConfig<GoogleSlidesResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/google_slides",
  category: "tools",
  bgColor: "#E0E0E0",
    ...
    config: {
      tool: (params) => {
        switch (params.operation) {
          ...
          default:
            throw new Error(
              `Invalid Google Slides operation: ${params.operation}`
            );
        }
      },
      params: (params) => {
        ...
        if (params.operation === "add_slide" && params.insertionIndex) {
          result.insertionIndex = Number.parseInt(
            params.insertionIndex as string,
            10
          );
        }
  ...
  inputs: {
    ...
    manualPresentationId: {
      type: "string",
      description: "Manual presentation identifier",
    },
    // Write operation
    ...
    placeholderIdMappings: {
      type: "string",
      description: "JSON array of placeholder ID mappings",
    },
    // Add image operation
    ...
    thumbnailPageId: {
      type: "string",
      description: "Slide object ID for thumbnail",
    },
  ...
  outputs: {
    ...
    slideId: {
      type: "string",
      description: "Object ID of newly created slide",
    },
    // Add image operation
    imageId: {
      type: "string",
      description: "Object ID of newly created image",
    },
    // Get thumbnail operation
