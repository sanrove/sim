...
export const JiraBlock: BlockConfig<JiraResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/jira",
  category: "tools",
  bgColor: "#E0E0E0",
  icon: JiraIcon,
  subBlocks: [
    ...
    // Assign Issue fields
    {
      ...
      condition: {
        field: "operation",
        value: ["assign", "add_watcher", "remove_watcher"],
      },
    },
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["search", "get_comments", "get_worklogs"],
      },
    },
    // Comment fields
    {
      ...
      condition: {
        field: "operation",
        value: ["add_comment", "update_comment"],
      },
    },
    {
      id: "commentId",
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["add_worklog", "update_worklog"],
      },
    },
    {
      id: "started",
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["update_worklog", "delete_worklog"],
      },
    },
    // Issue Link fields
    {
    ...
    config: {
      tool: (params) => {
        const effectiveProjectId = (
          params.projectId ||
          params.manualProjectId ||
          ""
        ).trim();
        const effectiveIssueKey = (
          params.issueKey ||
          params.manualIssueKey ||
          ""
        ).trim();
        ...
        switch (params.operation) {
          ...
          case "read-bulk": {
            ...
            const finalProjectId =
              params.projectId || params.manualProjectId || "";
          ...
          case "search": {
            return {
              ...
              maxResults: params.maxResults
                ? Number.parseInt(params.maxResults)
                : undefined,
            };
          }
          case "add_comment": {
          ...
          case "get_users": {
            return {
              ...
              startAt: params.usersStartAt
                ? Number.parseInt(params.usersStartAt)
                : undefined,
  ...
  inputs: {
    ...
    manualProjectId: {
      type: "string",
      description: "Manual project identifier",
    },
    ...
    deleteSubtasks: {
      type: "string",
      description: "Whether to delete subtasks (true/false)",
    },
    ...
    transitionId: {
      type: "string",
      description: "Transition ID for workflow status changes",
    },
    transitionComment: {
      type: "string",
    ...
    jql: {
      type: "string",
      description: "JQL (Jira Query Language) search query",
    },
    maxResults: {
      type: "string",
    ...
    commentBody: {
      type: "string",
      description: "Text content for comment operations",
    },
    commentId: {
      type: "string",
    ...
    attachmentId: {
      type: "string",
      description: "Attachment ID for delete operation",
    },
    ...
    worklogComment: {
      type: "string",
      description: "Optional comment for worklog",
    },
    started: {
      type: "string",
      description: "ISO timestamp when work started (optional)",
    },
    worklogId: {
      type: "string",
      description: "Worklog ID for update/delete operations",
    },
    // Issue Link operation inputs
    inwardIssueKey: {
      type: "string",
      description: "Inward issue key for creating link",
    },
    outwardIssueKey: {
      type: "string",
      description: "Outward issue key for creating link",
    },
    linkType: {
      type: "string",
      description: 'Type of link (e.g., "Blocks", "Relates")',
    },
    linkComment: {
      type: "string",
      description: "Optional comment for issue link",
    },
    ...
    usersStartAt: {
      type: "string",
      description: "Pagination start index for users",
    },
  ...
  outputs: {
    ...
    assignee: {
      type: "string",
      description: "Issue assignee display name or account ID",
    },
    ...
    issues: {
      type: "json",
      description:
        "Array of matching issues with key, summary, status, assignee, dates",
    },
    ...
    attachments: {
      type: "json",
      description:
        "Array of attachments with id, filename, size, mimeType, created, author",
    },
    ...
    users: {
      type: "json",
      description:
        "Array of users with accountId, displayName, emailAddress, active status",
    },
    ...
    priority_name: {
      type: "string",
      description: "Issue priority from webhook",
    },
    status_name: { type: "string", description: "Issue status from webhook" },
    assignee_name: {
      type: "string",
      description: "Assignee display name from webhook",
    },
    assignee_email: {
      type: "string",
      description: "Assignee email from webhook",
    },
    reporter_name: {
      type: "string",
      description: "Reporter display name from webhook",
    },
    reporter_email: {
      type: "string",
      description: "Reporter email from webhook",
    },
    comment_id: {
      type: "string",
    ...
    changelog: {
      type: "json",
      description: "Changelog object (for update events)",
    },
