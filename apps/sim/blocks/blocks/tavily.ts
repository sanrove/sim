...
export const TavilyBlock: BlockConfig<TavilyResponse> = {
  ...
  category: "tools",
  docsLink: "https://docs.ethana.ai/tools/tavily",
  bgColor: "#0066FF",
  icon: TavilyIcon,
  subBlocks: [
    {
    ...
    },
    {
      ...
      type: "long-input",
      placeholder:
        "^private\\.example\\.com$ (regex patterns, comma-separated)",
      condition: { field: "operation", value: ["tavily_crawl", "tavily_map"] },
    },
    {
      id: "allow_external",
  ...
  inputs: {
    ...
    include_raw_content: {
      type: "string",
      description: "Include raw content format",
    },
    include_images: {
      type: "boolean",
    ...
    select_domains: {
      type: "string",
      description: "Domain patterns to include",
    },
  ...
  outputs: {
    ...
    auto_parameters: {
      type: "json",
      description: "Auto-selected parameters (search)",
    },
    // Extract outputs
    ...
    base_url: {
      type: "string",
      description: "Base URL that was crawled/mapped",
    },
    response_time: {
      type: "number",
