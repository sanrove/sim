...
export const GitLabBlock: BlockConfig<GitLabResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/gitlab",
  category: "tools",
  icon: GitLabIcon,
  bgColor: "#E0E0E0",
  subBlocks: [
        ...
        switch (params.operation) {
          ...
          case "gitlab_list_issues":
            ...
            return {
              ...
              projectId: params.projectId.trim(),
              state:
                params.issueState !== "all" ? params.issueState : undefined,
          ...
          case "gitlab_create_issue_note":
            if (
              ...
              throw new Error(
                "Project ID, Issue IID, and comment body are required."
              );
            }
            return {
              ...baseParams,
          ...
          case "gitlab_create_merge_request":
            if (
              ...
              throw new Error(
                "Project ID, title, source branch, and target branch are required."
              );
            }
            return {
              ...baseParams,
          ...
          case "gitlab_merge_merge_request":
            ...
            return {
              ...
              mergeRequestIid: Number(params.mergeRequestIid),
              mergeCommitMessage:
                params.mergeCommitMessage?.trim() || undefined,
          ...
          case "gitlab_create_merge_request_note":
            if (
              ...
              throw new Error(
                "Project ID, Merge Request IID, and comment body are required."
              );
            }
            return {
              ...baseParams,
  ...
  inputs: {
    ...
    ref: {
      type: "string",
      description: "Branch or tag reference for pipeline",
    },
