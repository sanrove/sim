...
export const OutlookBlock: BlockConfig<OutlookResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/outlook",
  category: "tools",
  triggerAllowed: true,
  bgColor: "#E0E0E0",
  icon: OutlookIcon,
  ...
  inputs: {
    ...
    manualDestinationFolder: {
      type: "string",
      description: "Manual destination folder ID",
    },
    destinationId: {
      type: "string",
    ...
    copyDestinationFolder: {
      type: "string",
      description: "Copy destination folder ID",
    },
    manualCopyDestinationFolder: {
      type: "string",
    ...
    copyDestinationId: {
      type: "string",
      description: "Destination folder ID for copy",
    },
  },
  outputs: {
    // Common outputs
