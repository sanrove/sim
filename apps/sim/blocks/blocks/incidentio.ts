...
export const IncidentioBlock: BlockConfig<IncidentioResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/incidentio",
  category: "tools",
  bgColor: "#E0E0E0",
  icon: IncidentioIcon,
  subBlocks: [
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: "incidentio_custom_fields_create",
      },
      required: true,
    },
    ...
    // Incident Updates inputs
    {
      ...
      condition: {
        field: "operation",
        value: "incidentio_incident_updates_list",
      },
      required: false,
    },
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: "incidentio_schedule_entries_list",
      },
    },
    {
      id: "entry_window_end",
    ...
    // Schedule Overrides inputs
    {
      ...
      condition: {
        field: "operation",
        value: "incidentio_schedule_overrides_create",
      },
      required: true,
    },
    {
    ...
    config: {
      tool: (params) => {
        ...
        if (params.notify_incident_channel !== undefined) {
          params.notify_incident_channel =
            params.notify_incident_channel === "true";
        }
  ...
  outputs: {
    ...
    incident_timestamps: {
      type: "json",
      description: "List of incident timestamps",
    },
    incident_timestamp: {
      type: "json",
      description: "Incident timestamp details",
    },
    // Incident Updates
