...
export const SalesforceBlock: BlockConfig<SalesforceResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/salesforce",
  category: "tools",
  bgColor: "#E0E0E0",
  icon: SalesforceIcon,
  subBlocks: [
    ...
    // Lead fields
    {
      ...
      condition: {
        field: "operation",
        value: ["get_leads", "update_lead", "delete_lead"],
      },
    },
    {
      id: "company",
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["create_opportunity", "update_opportunity"],
      },
    },
    {
      id: "closeDate",
    ...
    // Case fields
    {
      ...
      condition: {
        field: "operation",
        value: ["get_cases", "update_case", "delete_case"],
      },
    },
    {
      id: "subject",
    ...
    // Task fields
    {
      ...
      condition: {
        field: "operation",
        value: ["get_tasks", "update_task", "delete_task"],
      },
    },
    {
      id: "activityDate",
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["list_reports", "list_dashboards"],
      },
    },
    {
      id: "searchTerm",
    ...
    // Dashboard fields
    {
      ...
      condition: {
        field: "operation",
        value: ["get_dashboard", "refresh_dashboard"],
      },
      required: true,
    },
    // Query fields
