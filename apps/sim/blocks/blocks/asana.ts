...
export const AsanaBlock: BlockConfig<AsanaResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/asana",
  category: "tools",
  bgColor: "#E0E0E0",
  icon: AsanaIcon,
  subBlocks: [
        ...
        switch (operation) {
          case "get_task":
            return {
              ...
              limit: params.getTasks_limit
                ? Number(params.getTasks_limit)
                : undefined,
            };
          case "create_task":
            return {
  ...
  inputs: {
    ...
    getTasks_workspace: {
      type: "string",
      description: "Workspace GID for getting tasks",
    },
    getTasks_project: {
      type: "string",
      description: "Project GID filter for getting tasks",
    },
  ...
  outputs: {
    ...
    permalink_url: {
      type: "string",
      description: "URL to the resource in Asana",
    },
