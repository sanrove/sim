...
export const VideoGeneratorBlock: BlockConfig<VideoBlockResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/video-generator",
  category: "tools",
  bgColor: "#181C1E",
  icon: VideoIcon,
  ...
  inputs: {
    ...
    resolution: {
      type: "string",
      description:
        "Video resolution - not available for MiniMax (fixed per endpoint)",
    },
    visualReference: {
      type: "json",
      description: "Reference image for Runway (UserFile)",
    },
    consistencyMode: {
      type: "string",
      description:
        "Consistency mode for Runway (character, object, style, location)",
    },
    ...
    cameraControl: {
      type: "json",
      description:
        "Camera controls for Luma (pan, zoom, tilt, truck, tracking)",
    },
  },
