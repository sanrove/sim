...
export const WealthboxBlock: BlockConfig<WealthboxResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/wealthbox",
  category: "tools",
  bgColor: "#E0E0E0",
  icon: WealthboxIcon,
  subBlocks: [
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["read_contact", "write_task", "write_note"],
      },
    },
    {
      id: "manualContactId",
    ...
    },
    {
      ...
      condition: {
        field: "operation",
        value: ["write_note", "write_event", "write_task"],
      },
      required: true,
    },
    {
  ...
  inputs: {
    ...
    manualContactId: {
      type: "string",
      description: "Manual contact identifier",
    },
  ...
  outputs: {
    note: {
      type: "json",
      description:
        "Single note object with ID, content, creator, and linked contacts",
    },
    notes: {
      type: "json",
      description: "Array of note objects from bulk read operations",
    },
    contact: {
      type: "json",
      description:
        "Single contact object with name, email, phone, and background info",
    },
    contacts: {
      type: "json",
      description: "Array of contact objects from bulk read operations",
    },
    task: {
      type: "json",
      description:
        "Single task object with name, due date, description, and priority",
    },
    tasks: {
      type: "json",
      description: "Array of task objects from bulk read operations",
    },
    metadata: {
      type: "json",
      description:
        "Operation metadata including item IDs, types, and operation details",
    },
    success: {
      type: "boolean",
      description:
