...
export const YouTubeBlock: BlockConfig<YouTubeResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/youtube",
  category: "tools",
  bgColor: "#FF0000",
  icon: YouTubeIcon,
  subBlocks: [
  ...
  inputs: {
    ...
    publishedAfter: {
      type: "string",
      description: "Published after date (RFC 3339)",
    },
    publishedBefore: {
      type: "string",
      description: "Published before date (RFC 3339)",
    },
    ...
    videoCaption: {
      type: "string",
      description: "Caption availability filter",
    },
  ...
  outputs: {
    ...
    description: {
      type: "string",
      description: "Video or channel description",
    },
