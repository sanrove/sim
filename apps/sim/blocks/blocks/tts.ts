...
export const TtsBlock: BlockConfig<TtsBlockResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/blocks/tts",
  category: "tools",
  bgColor: "#181C1E",
  icon: TTSIcon,
  ...
  inputs: {
    provider: {
      type: "string",
      description:
        "TTS provider (openai, deepgram, elevenlabs, cartesia, google, azure, playht)",
    },
    ...
    model: {
      type: "string",
      description: "OpenAI model (tts-1, tts-1-hd, gpt-4o-mini-tts)",
    },
    voice: { type: "string", description: "Voice identifier" },
    responseFormat: {
      type: "string",
      description: "Audio format (mp3, opus, aac, flac, wav)",
    },
    speed: {
      type: "number",
      description: "Speech speed (0.25 to 4.0) or speed multiplier",
    },
    // Deepgram
    ...
    voiceId: {
      type: "string",
      description: "Voice ID (ElevenLabs, Google, Azure)",
    },
    ...
    style: {
      type: "string",
      description: "Style exaggeration or speaking style",
    },
    // Cartesia
  ...
  outputs: {
    ...
    audioFile: {
      type: "json",
      description: "Generated audio file object (UserFile)",
    },
    duration: {
      type: "number",
