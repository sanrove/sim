...
export const ZendeskBlock: BlockConfig = {
  ...
  docsLink: "https://docs.ethana.ai/tools/zendesk",
  ...
  outputs: {
    ...
    tickets: {
      type: "json",
      description: "Array of ticket objects (get_tickets)",
    },
    // Ticket operations - single
    ticket: {
      type: "json",
      description:
        "Single ticket object (get_ticket, create_ticket, update_ticket)",
    },
    // User operations - list
    users: {
      type: "json",
      description: "Array of user objects (get_users, search_users)",
    },
    // User operations - single
    user: {
      type: "json",
      description:
        "Single user object (get_user, get_current_user, create_user, update_user)",
    },
    // Organization operations - list
    organizations: {
      type: "json",
      description:
        "Array of organization objects (get_organizations, autocomplete_organizations)",
    },
    ...
    results: {
      type: "json",
      description: "Array of search result objects (search)",
    },
    count: {
      type: "number",
      description: "Number of matching results (search_count)",
    },
    ...
    deleted: {
      type: "boolean",
      description:
        "Deletion confirmation (delete_ticket, delete_user, delete_organization)",
    },
    ...
    metadata: {
      type: "json",
      description: "Operation metadata including operation type",
    },
  },
};
