...
export const MicrosoftPlannerBlock: BlockConfig<MicrosoftPlannerResponse> = {
  ...
  docsLink: "https://docs.ethana.ai/tools/microsoft_planner",
  category: "tools",
  bgColor: "#E0E0E0",
  ...
  subBlocks: [
    ...
    // Bucket ID for bucket operations
    {
      ...
      condition: {
        field: "operation",
        value: ["read_bucket", "update_bucket", "delete_bucket"],
      },
      dependsOn: ["credential"],
    },
    ...
    // Name for bucket operations
    {
      ...
      condition: {
        field: "operation",
        value: ["create_bucket", "update_bucket"],
      },
    },
    ...
    // Description for task details
    {
      ...
      condition: {
        field: "operation",
        value: ["create_task", "update_task_details"],
      },
    },
    ...
    // Due Date
    {
      ...
      type: "short-input",
      placeholder:
        "Enter due date in ISO 8601 format (e.g., 2024-12-31T23:59:59Z)",
      condition: { field: "operation", value: ["create_task", "update_task"] },
    },
    ...
    // Preview Type
    {
      ...
      type: "short-input",
      placeholder:
        "Enter preview type (automatic, noPreview, checklist, description, reference)",
      condition: { field: "operation", value: ["update_task_details"] },
    },
  ],
  tools: {
    ...
    config: {
      tool: (params) => {
        switch (params.operation) {
          ...
          default:
            throw new Error(
              `Invalid Microsoft Planner operation: ${params.operation}`
            );
        }
      },
      params: (params) => {
  ...
  inputs: {
    ...
    bucketIdForRead: {
      type: "string",
      description: "Bucket ID for read operations",
    },
    title: { type: "string", description: "Task title" },
    name: { type: "string", description: "Bucket name" },
    description: {
      type: "string",
      description: "Task or task details description",
    },
    ...
    previewType: {
      type: "string",
      description: "Preview type for task details",
    },
  },
  outputs: {
    message: {
    ...
    etag: {
      type: "string",
      description:
        "ETag of the resource - use this for update/delete operations",
    },
    plan: {
      type: "json",
    ...
    taskDetails: {
      type: "json",
      description:
        "The Microsoft Planner task details including checklist and references",
    },
    deleted: {
      type: "boolean",
