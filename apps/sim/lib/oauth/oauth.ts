  ...
  google: {
    ...
    services: {
      ...
      "google-docs": {
        name: "Google Docs",
        description:
          "Create, read, and edit Google Documents programmatically.",
      ...
      "google-vault": {
        name: "Google Vault",
        description:
          "Search, export, and manage matters/holds via Google Vault.",
      ...
      "vertex-ai": {
        name: "Vertex AI",
        description:
          "Access Google Cloud Vertex AI for Gemini models with OAuth.",
  ...
  notion: {
    ...
    services: {
      notion: {
        name: "Notion",
        description:
          "Connect to your Notion workspace to manage pages and databases.",
        providerId: "notion",
        icon: NotionIcon,
  ...
  pipedrive: {
    ...
    services: {
      pipedrive: {
        name: "Pipedrive",
        description:
          "Manage deals, contacts, and sales pipeline in Pipedrive CRM.",
  ...
  wordpress: {
    ...
    services: {
      wordpress: {
        name: "WordPress",
        description:
          "Manage posts, pages, media, comments, and more on WordPress sites.",
