...
<Callout type="info">
  ...
  générez une clé API Copilot dans l'application hébergée (ethana.ai →
  Paramètres → Copilot) 1. Allez sur [ethana.ai](https://ethana.ai) → Paramètres
  → Copilot et générez une clé API Copilot 2. Définissez `COPILOT_API_KEY` dans
  votre environnement auto-hébergé avec cette valeur
</Callout>
...
<Cards>
  ...
  >
    <div className="m-0 text-sm">
      Mode questions-réponses pour des explications, des conseils et des
      suggestions sans apporter de modifications à votre flux de travail.
    </div>
  </Card>
  <Card
    title={
  ...
  >
    <div className="m-0 text-sm">
      Mode de création et de modification. Copilot propose des modifications
      spécifiques (ajouter des blocs, connecter des variables, ajuster des
      paramètres) et les applique lorsque vous les approuvez.
    </div>
  </Card>
</Cards>
...
<Cards>
  ...
  >
    <div className="m-0 text-sm">
      Plus rapide et moins coûteux. Idéal pour les petites modifications, les
      flux de travail simples et les ajustements mineurs.
    </div>
  </Card>
  <Card
    title={
  ...
  >
    <div className="m-0 text-sm">
      Équilibre entre vitesse et raisonnement. Option par défaut recommandée
  ...
  >
    <div className="m-0 text-sm">
      Raisonnement plus poussé pour les flux de travail plus importants et les
      modifications complexes tout en restant performant.
    </div>
  </Card>
  <Card
    title={
  ...
  >
    <div className="m-0 text-sm">
      Raisonnement maximal pour la planification approfondie, le débogage et les
...
<Callout type="warning">
  Les prix indiqués reflètent les tarifs en date du 4 septembre 2025. Consultez
  la documentation du fournisseur pour les tarifs actuels.
</Callout>

<Callout type="info">
  Les prix des modèles sont par million de tokens. Le calcul divise par 1 000
  000 pour obtenir le coût réel. Consultez{" "}
  <a href="/execution/costs">la page de calcul des coûts</a> pour plus
  d'informations et des exemples.
</Callout>
