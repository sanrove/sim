...
<Callout type="info">
  Les prix des modèles d'IA sont par million de tokens. Le calcul divise par 1
  000 000 pour obtenir le coût réel. Les flux de travail sans blocs d'IA
  n'engendrent que les frais d'exécution de base.
</Callout>
...
<Callout type="warning">
  Les prix indiqués reflètent les tarifs en date du 10 septembre 2025. Consultez
  la documentation des fournisseurs pour les tarifs actuels.
</Callout>
...
- Examinez votre utilisation actuelle dans [Paramètres → Abonnement](https://ethana.ai/settings/subscription)
