...
<Callout type="info">
  AI model prices are per million tokens. The calculation divides by 1,000,000
  to get the actual cost. Workflows without AI blocks only incur the base
  execution charge.
</Callout>
...
<Callout type="warning">
  Pricing shown reflects rates as of September 10, 2025. Check provider
...
- Review your current usage in [Settings → Subscription](https://ethana.ai/settings/subscription)
